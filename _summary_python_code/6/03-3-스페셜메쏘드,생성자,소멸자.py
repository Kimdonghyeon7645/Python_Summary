...
__instancecheck__(self, instance) : 인스턴스가 정의한 클래스의 인스턴스인지 확인 (예 : isinstance(instance, class)).
__subclasscheck__(self, subclass) : 클래스가 정의한 클래스의 하위 클래스인지 확인 (예 : issubclass(subclass, class)).
